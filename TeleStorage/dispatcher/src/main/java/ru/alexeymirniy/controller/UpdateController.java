...
import ru.alexeymirniy.service.UpdateProducer;
import ru.alexeymirniy.util.MessageUtils;

import static ru.alexeymirniy.model.RabbitQueue.*;
...
public class UpdateController {
    ...
    private void setFileIsReceiveView(Update update) {
        ...
        var sendMessage = messageUtils.generateSendMessageWithText(update,
                "Файл получен! Идет процесс обработки...");
